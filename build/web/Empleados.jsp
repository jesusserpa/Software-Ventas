<!-- Importa la biblioteca JSTL para utilizar etiquetas en el código JSP -->
                    ...
                    <div>
                        <form action="Controlador?menu=Empleados" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="txtpassword" value="${usuarioSeleccionado.getPassword()}">
                            </div>
                            <div class="form-group">
                                <label>Rol</label>
