        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <form action="Controlador?menu=Productos" method="POST">
                    ...
                    <div class="form-group"style="margin-left: 10px;">
                        <!-- Campo de entrada para la unidad del producto -->
                        <label>Unidad</label>
                    ...
                    <!-- Botón para enviar el formulario y agregar un producto -->

                    <button type="submit" class="btn btn-primary" name="accion" value="Agregar" style="margin-left: 10px;">Guardar</button>
                </form>
            </div>
            <div class="col-md-8">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <!-- Utilizar JSTL para iterar a través de productos -->
